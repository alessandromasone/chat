...
public class ClientGui extends Thread {
    ...
    public static class TextListener implements DocumentListener {
        ...
        public void removeUpdate(DocumentEvent e) {
            jcbtn.setEnabled(!jtf1.getText().trim().isEmpty() &&
                    !jtf2.getText().trim().isEmpty() &&
                    !jtf3.getText().trim().isEmpty());
        }
    ...
    public ClientGui() {
        ...
        jsbtn.addActionListener(_ -> sendMessage());
